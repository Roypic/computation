...
class UNetConfig:
    ...
    def __init__(self,
                 ...
                 validation = 30.0,   # Percent of the data that is used as validation (0-100)
                 out_threshold = 0.5,
        ...
        self.testimages_dir='./data/test/input/images'
        self.testmasks_dir='./data/test/input/masks'
